...
PLAN_CASES = [
    ...
    (
        "plan_travel_redacts_system_paths_ipv6_and_bare_hex",
        {
            "enabled": True,
            "event_kind": "heartbeat",
            "now": "2026-04-20T12:00:00+00:00",
            ...
            "user_runs_today": 0,
            "host": "OpenClaw",
            "symptom": "auth failed at C:\\ProgramData\\OpenClaw\\secrets\\config.env",
            "constraint": "public-only check /etc/openclaw/token and http://[::1]:3000/callback",
            "desired_outcome": "safe query without abcdef1234567890abcdef1234567890",
            "no_clear_next_step": True,
        },
        "",
        True,
        "low",
        2,
        ["ProgramData", "/etc/openclaw", "::1", "abcdef1234567890abcdef1234567890"],
        ["secondary"],
    ),
    (
